...
export default function Services() {
  ...
  return (
    <div className={style.section}>
      ...
      <div className={style.p} data-aos="fade-up" data-aos-duration="1000">{t("The makers of the application make your bridge to the world of creativity and craftsmanship in the Emirates")}</div>
      ...
      {data.map((item, key) => (
          <div className={style.card} key={key} data-aos="flip-left" data-aos-duration="1500">
            ...
            <h1 className={style.card_h1}>{item.header}</h1>
            <div className={style.card_p}>{item.p}</div>
